...
function ProfileScreen() {
  ...
  const handleToggleNotifications = async (value) => {
    if (value) {
      ...
      if (hasPermission) {
        ...
        Alert.alert("Notifications Enabled", "You will receive a daily reminder at 9 AM to solve your puzzle!");
      } else {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#f9f9f9" }}>
      ...
      >
        {/* Stats Card */}
        <View style={{ backgroundColor: "#8b5cf6", padding: 24, borderRadius: 16, marginBottom: 20 }}>
          <Text style={{ fontSize: 18, fontWeight: "bold", color: "#fff", marginBottom: 20 }}>
            Your Stats
          </Text>
          <View style={{ gap: 16 }}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 14, color: "#e9d5ff" }}>Current Streak</Text>
                <Text style={{ fontSize: 24, fontWeight: "bold", color: "#fff" }}>{streak} days</Text>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ fontSize: 14, color: "#e9d5ff" }}>Puzzles Solved</Text>
                <Text style={{ fontSize: 24, fontWeight: "bold", color: "#fff" }}>{totalSolved}</Text>
              </View>
            </View>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 20, fontWeight: "bold", color: "#fff" }}>{getStreakBadge()}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        <View style={{ backgroundColor: "#fff", borderRadius: 16, overflow: "hidden", marginBottom: 20 }}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 16, borderBottomWidth: 1, borderBottomColor: "#f0f0f0" }}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
              ...
              <View>
                <Text style={{ fontSize: 16, fontWeight: "600" }}>Daily Reminder</Text>
                <Text style={{ fontSize: 14, color: "#6b7280" }}>Get notified at 9 AM</Text>
              </View>
            </View>
            <Switch
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 16, fontWeight: "600" }}>Report Inappropriate Ad</Text>
              <Text style={{ fontSize: 14, color: "#6b7280" }}>Help us maintain ad quality</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={{ backgroundColor: "#fff", padding: 20, borderRadius: 16 }}>
          <Text style={{ fontSize: 18, fontWeight: "bold", marginBottom: 16 }}>Achievement Badges</Text>
          <View style={{ gap: 12 }}>
            <Text style={{ fontSize: 14, color: "#6b7280" }}>🌱 Beginner - Start your journey</Text>
            <Text style={{ fontSize: 14, color: "#6b7280" }}>✨ Getting Started - 3 day streak</Text>
            <Text style={{ fontSize: 14, color: "#6b7280" }}>⭐ Week Warrior - 7 day streak</Text>
            <Text style={{ fontSize: 14, color: "#6b7280" }}>🔥 On Fire - 14 day streak</Text>
            <Text style={{ fontSize: 14, color: "#6b7280" }}>🏆 Legend - 30 day streak</Text>
          </View>
        </View>
      </ScrollView>
